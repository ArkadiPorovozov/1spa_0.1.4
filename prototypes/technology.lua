-------------------------------------------------------------------------- UNIVERSAL CHANGES
-------------------------------------------------------------------------- Существующие технологические модификации
...
data.raw.technology["rocket-fuel"].icon = "__1spa__/graphics/technology/rocket-fuel.png"

data.raw.technology["rocket-fuel-productivity"].icons = util.technology_icon_constant_recipe_productivity("__1spa__/graphics/technology/rocket-fuel-productivity.png")
...
{
	{
		...
		icon = "__1spa__/graphics/technology/orbital-mechanics.png",
		icon_size = 256,
		essential = true,
		effects =
		{
...
--  ----  ----  ----  ----  ----  ----  ----  --
	{
		...
		effects =
		{
			{
				type = "unlock-space-location",
				space_location = "sosal",
				use_icon_overlay_constant = true
			},
			{
				type = "unlock-space-location",
				space_location =  "sosal1",
				use_icon_overlay_constant = true
			},
			{
				type = "unlock-space-location",
				space_location =  "sosal2",
				use_icon_overlay_constant = true
			},
			{
				type = "unlock-space-location",
				space_location = "sosal3",
				use_icon_overlay_constant = true
			}
		},
		prerequisites = {"space-platform-thruster"},
...
--  ----  ----  ----  ----  ----  ----  ----  --
	{
		...
		icon = "__1spa__/graphics/technology/ferrarius-belt.png",
		icon_size = 256,
		essential = true,
		effects =
		{
	...
	},
	{
		...
		icon = "__1spa__/graphics/technology/carbolithic-belt.png",
		icon_size = 256,
		essential = true,
		effects =
		{
	...
	},
	{
		...
		icon = "__1spa__/graphics/technology/aquilite-cluster.png",
		icon_size = 256,
		essential = true,
		effects =
		{
